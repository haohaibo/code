...
![image](https://github.com/haohaibo/code/blob/main/materials/load_a_b_column.png#pic_center =200x200)


Fig 2. compute a squre of 2*2 results will need to have 9 loads and 1 store.
![image](https://github.com/haohaibo/code/blob/main/materials/load_a_b_c_square.png#pic_center =200x200)

Fig 3 compute 1 result will need to have 17 loads and 1 store
![image](https://github.com/haohaibo/code/blob/main/materials/load_a_b_c.png#pic_center =200x200)
